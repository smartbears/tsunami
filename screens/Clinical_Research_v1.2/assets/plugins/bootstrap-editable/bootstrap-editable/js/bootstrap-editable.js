    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **/          
        ...
        @property emptytext 
        @type string
        @default 'Add procedure'
        **/         
        emptytext: 'Add procedure',
        /**
        ...
        **Please note**, that delegated targets can't be initialized with `emptytext` and `autotext` options, 
        ...
        <div id="user">
          <!-- empty -->
          <a href="#" data-name="username" data-type="text" class="editable-click editable-empty" data-value="" title="Username">Add procedure</a>
          <!-- non-empty -->
