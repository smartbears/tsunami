App = Em.Application.create({
    ...
    dragStart: function(a) {
        a.dataTransfer.setData("text/data", this.get("file.id"));
    }
}), App.DroppableTrashComponent = Ember.Component.extend({
    overTrash: !1,
    dragEnter: function() {
        this.set("overTrash", !0);
    },
    dragLeave: function() {
        this.set("overTrash", !1);
    },
    dragOver: function(a) {
        a.preventDefault();
    },
    drop: function(a) {
        id = a.dataTransfer.getData("text/data"), record = this.get("inFolder").findProperty("id", parseInt(id)), 
        this.set("overTrash", !1), this.get("inTrash").pushObject(record), this.get("inFolder").removeObject(record);
    }
});
...
DS.WebAPISerializer = DS.RESTSerializer.extend({
    ...
    actions: {
        add: function() {
            ...
            a.save(), this.transitionToRoute("subjects");
        }
    }
});