...
DS.WebAPISerializer = DS.RESTSerializer.extend({
    ...
    actions: {
        ...
        doneRenaming: function() {
            var a = this.get("model");
            a.save(), this.toggleProperty("isRenamingView");
        },
        acceptElement: function(a, b) {
            var c = this.get("controllers.procedures").store.getById("procedure", a);
    ...
    actions: {
        newProcedure: function() {
            this.toggleProperty("isCreating"), this.transitionToRoute("procedures");
        },
        ...
        newVisit: function() {
            ...
            var a = this.get("visitCount"), b = this.store.createRecord("visit", {
                label: "Visit " + a
            });
            b.save();
