...
DS.WebAPIAdapter = DS.RESTAdapter.extend({
    ...
    updateRecord: function(a, b, c) {
        ...
        d = a.serializerFor(b.typeKey).serialize(c);
        var e = get(c, "id");
        return d.id = e, this.ajax(this.buildURL(b.typeKey, e), "PUT", {
            data: d
        }, c);
    },
    ajax: function(a, b, c, d) {
        ...
        return new Ember.RSVP.Promise(function(e, f) {
            if (c = c || {}, c.url = a, c.type = b, c.dataType = "json", c.context = g, c.data && "GET" !== b && (c.contentType = "application/json; charset=utf-8", 
...
DS.WebAPISerializer = DS.RESTSerializer.extend({
    ...
    actions: {
        update: function() {
            ...
            a.save(), this.transitionToRoute("subject", a);
        }
    }
});