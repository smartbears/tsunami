...
DS.WebAPISerializer = DS.RESTSerializer.extend({
    ...
    actions: {
        ...
        acceptElement: function(a, b) {
            ...
            $("#" + b + " .col-md-5 ." + a).length <= 0 ? $("#" + b + " .col-md-5").append('<div class="list-group-item ' + a + '" style="font-size: 14px;">' + c.get("name") + "</div>") : alert('The procedure "' + c.get("name") + '" already exist in the current visit.');
        },
        destroyProcedure: function(a) {
