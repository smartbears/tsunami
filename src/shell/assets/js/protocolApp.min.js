...
ProtocolApp.VisitController = Ember.ObjectController.extend({
    ...
    actions: {
        drop_procedure_into_visit: function(a) {
            ...
            if (!this.model.get("procedureIds")) this.model.set("procedureIds", [ b.id ]); else if (!this.model.get("procedureIds").contains(b.id)) this.model.get("procedureIds").pushObject(b.id);
        },
