...
ProtocolApp.VisitItemComponent = Em.Component.extend({
    ...
    actions: {
        drop_procedure_into_visit: function(a) {
            this.sendAction("dropProcedure", a);
        },
...
ProtocolApp.VisitController = Ember.ObjectController.extend({
    ...
    actions: {
        drop_procedure_into_visit: function(a) {
            ...
            if (!this.model.get("procedureIds")) this.model.set("procedureIds", [ b.id ]); else if (!this.model.get("procedureIds").contains()) this.model.get("procedureIds").pushObject(b.id);
        },
        insertNewProcedure: function(a) {
