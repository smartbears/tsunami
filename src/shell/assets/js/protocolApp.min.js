...
ProtocolApp.VisitController = Ember.ObjectController.extend({
    ...
    actions: {
        drop_procedure_into_visit: function(a) {
            var b = this.get("controllers.procedures").store.getById("procedure", a);
            var c = false;
            if (!this.get("procedures")) this.set("procedures", [ b ]); else {
                var d = this.get("procedures");
                for (var e = 0; e < d.length; e++) {
                    if (d[e].get("id") === b.get("id")) {
                        c = true;
                        break;
                    }
                }
                if (c) {
                    ...
                    this.get("procedures").pushObject(b);
                }
            }
        },
        insertNewProcedure: function(a) {
            ...
            if (!this.get("procedures")) this.set("procedures", [ b ]); else this.get("procedures").pushObject(b);
        },
        editLabel: function() {
