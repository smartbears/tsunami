...
Ember.TEMPLATES["protocols/configure"] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = helpers.each.call(depth0, "visitProc", "in", "visit.procedures", {"name":"each","hash":{
    'itemController': ("procedure")
  },"hashTypes":{'itemController': "STRING"},"hashContexts":{'itemController': depth0},"fn":this.program(23, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                <p class=\"count_proc\" id=\"\" style=\"display:none\"> 17 procedures</p>\r\n              </ul>\r\n              <button style=\"display:block\" class=\"btn bg-gray  addProc\">\r\n                <i class=\"glyphicon-plus glyphicon\"></i>\r\n              </button>\r\n            </div>\r\n          </div>\r\n        </div>       \r\n\r\n");
  return buffer;
  ...
  var stack1, buffer = '';
  data.buffer.push("                  <li class=\"ui-state-default\">\r\n");
  stack1 = helpers.unless.call(depth0, "visitProc.isEditingName", {"name":"unless","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(24, data),"inverse":this.program(26, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                  </li>\r\n");
  return buffer;
  ...
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push(" procedures</p>\r\n        <button style=\"display:block\" id= \"proc\" class=\" btn bg-gray addProc\"><i class=\"glyphicon-plus glyphicon\"></i></button>\r\n      </div>\r\n    </div>\r\n\r\n      \r\n    \r\n    \r\n");
