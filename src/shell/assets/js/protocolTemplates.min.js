...
Ember.TEMPLATES["protocols/configure"] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = ((helpers['drag-element'] || (depth0 && depth0['drag-element']) || helperMissing).call(depth0, {"name":"drag-element","hash":{
    ...
    'elementName': ("num"),
    'item': ("procedure.name")
  },"hashTypes":{'dragType': "STRING",'elementName': "STRING",'item': "ID"},"hashContexts":{'dragType': depth0,'elementName': depth0,'item': depth0},"fn":this.program(6, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  return buffer;
},"6":function(depth0,helpers,partials,data) {
  var stack1, buffer = '';
  data.buffer.push("              <li class=\"ui-state-default scroll_El\">\r\n                <span>\r\n");
  stack1 = helpers.unless.call(depth0, "procedure.isEditing", {"name":"unless","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(7, data),"inverse":this.program(9, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                </li>\r\n");
  return buffer;
},"7":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("                    <a class=\"add-new-proc\" href=\"#\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "rename_procedure", "procedure", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING","ID"],"contexts":[depth0,depth0],"data":data})));
  data.buffer.push(">\r\n                      ");
  ...
  },"hashTypes":{'elementName': "STRING",'dropAction': "STRING"},"hashContexts":{'elementName': depth0,'dropAction': depth0},"fn":this.program(12, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  stack1 = ((helpers.ifIsNthItem || (depth0 && depth0.ifIsNthItem) || helperMissing).call(depth0, {"name":"ifIsNthItem","hash":{
    'nth': (4),
    'startAt': (3)
  },"hashTypes":{'nth': "NUMBER",'startAt': "NUMBER"},"hashContexts":{'nth': depth0,'startAt': depth0},"fn":this.program(15, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  return buffer;
  ...
  stack1 = helpers.each.call(depth0, "visitProc", "in", "visit.procedures", {"name":"each","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(13, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n");
  return buffer;
  ...
  stack1 = helpers._triageMustache.call(depth0, "visitProc", {"name":"_triageMustache","hash":{},"hashTypes":{},"hashContexts":{},"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("</div>\r\n");
  return buffer;
  ...
  stack1 = helpers.each.call(depth0, "procedure", "in", "procedures", {"name":"each","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(5, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  ...
  },"hashTypes":{'itemController': "STRING"},"hashContexts":{'itemController': depth0},"fn":this.program(11, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
