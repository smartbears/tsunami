...
Ember.TEMPLATES["protocols/configure"] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("</h4>\r\n                  <ul class=\"connectedSortable col-sm-12\">\r\n");
  ...
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                  </ul>\r\n                  <p class=\"count_proc\" id=\"\" style=\"display:block\"> 17 procedures</p>\r\n                  <button style=\"display:block\" class=\"btn bg-gray  addProc\">+</button>\r\n                </div>\r\n              </div>\r\n");
  return buffer;
  ...
  var stack1, buffer = '';
  data.buffer.push("                          <li class=\"ui-state-default \">\r\n                            <a class=\"procedure editable-click editable-empty\">");
  ...
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
    ...
    'class': ("procedure editable editable-click editable-empty")
