...
Ember.TEMPLATES["protocols/configure"] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = ((helpers['drag-element'] || (depth0 && depth0['drag-element']) || helperMissing).call(depth0, {"name":"drag-element","hash":{
    ...
    'elementName': ("num"),
    'item': ("procedure.name")
  },"hashTypes":{'dragType': "STRING",'elementName': "STRING",'item': "ID"},"hashContexts":{'dragType': depth0,'elementName': depth0,'item': depth0},"fn":this.program(10, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  return buffer;
},"10":function(depth0,helpers,partials,data) {
  var stack1, buffer = '';
  data.buffer.push("              <li class=\"ui-state-default scroll_El\">\r\n                <span>\r\n");
  stack1 = helpers.unless.call(depth0, "procedure.isEditing", {"name":"unless","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(11, data),"inverse":this.program(13, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                </li>\r\n");
  return buffer;
  ...
  stack1 = ((helpers.ifIsNthItem || (depth0 && depth0.ifIsNthItem) || helperMissing).call(depth0, {"name":"ifIsNthItem","hash":{
    'nth': (4),
    'startAt': (3)
  },"hashTypes":{'nth': "NUMBER",'startAt': "NUMBER"},"hashContexts":{'nth': depth0,'startAt': depth0},"fn":this.program(19, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  return buffer;
  ...
  stack1 = helpers.each.call(depth0, "visitProc", "in", "visit.procedures", {"name":"each","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(17, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n");
  return buffer;
  ...
  stack1 = helpers.each.call(depth0, "procedure", "in", "procedures", {"name":"each","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(9, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
