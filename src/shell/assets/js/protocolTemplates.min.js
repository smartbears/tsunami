...
Ember.TEMPLATES["protocols/configure"] = Ember.HTMLBars.template((function() {
  ...
  var child1 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element8, context, "action", ["editName"], {});
  ...
  var child3 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element7, context, "action", ["editDescription"], {});
      ...
      var child0 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            var morph0 = dom.createMorphAt(element6,0,1);
            element(env, element6, context, "action", ["editName"], {});
  ...
  var child6 = (function() {
    var child0 = (function() {
      var child0 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
            inline(env, morph0, context, "input", [], {"value": get(env, context, "visit.label"), "placeholder": "AddVisit", "class": "visit-title h4 col-sm-10", "focus-out": "updateLabel", "insert-newline": "updateLabel"});
            return fragment;
          }
        };
      }());
      var child1 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.setAttribute(el1,"class","visit-title h4 col-sm-10");
            var el2 = dom.createTextNode("\n                        ");
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n                      ");
            dom.appendChild(el1, el2);
          ...
          render: function render(context, env, contextualElement) {
            ...
            element(env, element2, context, "action", ["editLabel"], {});
            content(env, morph0, context, "visit.label");
            return fragment;
          }
        };
      }());
      var child2 = (function() {
        var child0 = (function() {
          var child0 = (function() {
            return {
              ...
              build: function build(dom) {
                ...
                dom.appendChild(el0, el1);
                var el1 = dom.createElement("span");
                dom.setAttribute(el1,"class","procedure");
                dom.appendChild(el0, el1);
                var el1 = dom.createTextNode("\n");
                dom.appendChild(el0, el1);
                return el0;
              ...
              render: function render(context, env, contextualElement) {
                ...
                content(env, morph0, context, "visitProc.name");
                return fragment;
              }
            };
          }());
          var child1 = (function() {
            return {
              ...
              render: function render(context, env, contextualElement) {
                ...
                var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
                inline(env, morph0, context, "input", [], {"value": get(env, context, "visitProc.name"), "placeholder": "Add Procedure", "class": "procedure", "focus-out": "updateName", "insert-newline": "updateName"});
                return fragment;
              }
            };
          }());
          return {
            ...
            render: function render(context, env, contextualElement) {
              ...
              var morph0 = dom.createMorphAt(dom.childAt(fragment, [1]),0,1);
              block(env, morph0, context, "unless", [get(env, context, "visitProc.isEditingName")], {}, child0, child1);
              return fragment;
            }
          };
        }());
        return {
          ...
          build: function build(dom) {
            ...
            dom.setAttribute(el1,"class","connectedSortable sortable col-sm-12 ui-droppable ui-sortable");
            var el2 = dom.createTextNode("\n");
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("                        ");
            dom.appendChild(el1, el2);
            var el2 = dom.createElement("p");
            dom.setAttribute(el2,"class","count_proc pull-right");
            var el3 = dom.createTextNode(" ");
            dom.appendChild(el2, el3);
          ...
          render: function render(context, env, contextualElement) {
            ...
            block(env, morph0, context, "each", [get(env, context, "visit.procedures")], {"itemController": "procedure", "keyword": "visitProc"}, child0, null);
            content(env, morph1, context, "visit.proceduresCount");
            return fragment;
          }
        };
      }());
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el1,"id","col1");
          var el2 = dom.createTextNode("\n                ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("div");
          dom.setAttribute(el2,"id","visit1");
          dom.setAttribute(el2,"class","visit row margin-row");
          var el3 = dom.createTextNode("\n                  ");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("div");
          dom.setAttribute(el3,"class","visit_N");
          var el4 = dom.createTextNode("\n");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("                    ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","col-sm-2 clickable glyphicon glyphicon-chevron-up collapse pull-right");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n                  ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("div");
          dom.setAttribute(el3,"class","visit-body");
          var el4 = dom.createTextNode("\n");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("                    ");
          dom.appendChild(el3, el4);
        ...
        render: function render(context, env, contextualElement) {
          ...
          block(env, morph0, context, "if", [get(env, context, "visit.isEditingLabel")], {}, child0, child1);
          block(env, morph1, context, "if", [get(env, context, "visit.haveProcedures")], {}, child2, null);
          element(env, element5, context, "action", ["insertNewProcedure", get(env, context, "this")], {});
          return fragment;
        }
      };
    }());
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph0, context, "drop-element", [], {"dropAction": "drop_procedure_into_visit", "elementName": "visit"}, child0, null);
        block(env, morph1, context, "ifIsNthItem", [], {"startAt": 3, "nth": 4}, child1, null);
        return fragment;
      }
    };
  }());
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element12 = dom.childAt(element9, [3, 1]);
      var element13 = dom.childAt(element12, [7]);
      var element14 = dom.childAt(element9, [5, 1, 1, 1]);
      var element15 = dom.childAt(element14, [4, 1, 1, 3]);
      var morph0 = dom.createMorphAt(element10,0,1);
      var morph1 = dom.createMorphAt(element10,1,2);
      var morph2 = dom.createMorphAt(dom.childAt(element12, [3]),0,1);
      var morph3 = dom.createMorphAt(dom.childAt(element12, [5]),0,1);
      var morph4 = dom.createMorphAt(element14,0,1);
...
Ember.TEMPLATES["protocols/index"] = Ember.HTMLBars.template((function() {
  ...
  var child1 = (function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, get = hooks.get, attribute = hooks.attribute, block = hooks.block, element = hooks.element;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var morph0 = dom.createMorphAt(dom.childAt(element0, [1]),0,1);
        attribute(env, attrMorph0, element0, "id", get(env, context, "item.id"));
