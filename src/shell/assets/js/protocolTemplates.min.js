...
Ember.TEMPLATES["protocols/configure"] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("        <h1 class=\"title color-dark\">\r\n          ");
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("            <p class=\"color-dark\">\r\n              ");
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
  ...
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("          <p class=\"color-dark\"style=\" display: inline-block; font-weight: initial;\" ");
  ...
  var stack1, buffer = '';
  data.buffer.push("\r\n");
  stack1 = helpers.unless.call(depth0, "procedure.isEditingName", {"name":"unless","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(10, data),"inverse":this.program(13, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("              \r\n");
  return buffer;
  ...
  stack1 = ((helpers['drag-element'] || (depth0 && depth0['drag-element']) || helperMissing).call(depth0, {"name":"drag-element","hash":{
    'elementName': ("num"),
    'item': ("procedure.id")
  },"hashTypes":{'elementName': "STRING",'item': "ID"},"hashContexts":{'elementName': depth0,'item': depth0},"fn":this.program(11, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  return buffer;
},"11":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("                    <li class=\"ui-state-default draggable\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "editName", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING"],"contexts":[depth0],"data":data})));
  data.buffer.push(">\r\n                      ");
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("                  <li class=\"ui-state-default\">          \r\n                    ");
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
    'insert-newline': ("updateName"),
    'focus-out': ("updateName"),
  ...
  },"hashTypes":{'elementName': "STRING",'dropAction': "STRING"},"hashContexts":{'elementName': depth0,'dropAction': depth0},"fn":this.program(18, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  stack1 = ((helpers.ifIsNthItem || (depth0 && depth0.ifIsNthItem) || helperMissing).call(depth0, {"name":"ifIsNthItem","hash":{
    'nth': (4),
    'startAt': (3)
  },"hashTypes":{'nth': "NUMBER",'startAt': "NUMBER"},"hashContexts":{'nth': depth0,'startAt': depth0},"fn":this.program(29, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\r\n");
  return buffer;
},"18":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("        <div class=\"col-sm-3 col-sm-2_4\" id=\"col1\">     \r\n          <div id=\"visit1\" class=\" visit row margin-row\">\r\n            <div class=\"visit_N\">\r\n");
  stack1 = helpers['if'].call(depth0, "visit.isEditingLabel", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(19, data),"inverse":this.program(21, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("              <i class=\"col-sm-2 clickable glyphicon glyphicon-chevron-up collapse pull-right\"></i>              \r\n            </div>\r\n            <div class=\"visit-body\">\r\n");
  stack1 = helpers['if'].call(depth0, "visit.haveProcedures", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(23, data),"inverse":this.noop,"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("              <button style=\"display:block\" class=\"btn bg-gray addProc\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "insertNewProcedure", "", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING","ID"],"contexts":[depth0,depth0],"data":data})));
  ...
  data.buffer.push("                ");
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
    'insert-newline': ("updateLabel"),
    'focus-out': ("updateLabel"),
    'class': ("visit-title h4 col-sm-10"),
    'placeholder': ("AddVisit"),
    'value': ("visit.label")
  },"hashTypes":{'insert-newline': "STRING",'focus-out': "STRING",'class': "STRING",'placeholder': "STRING",'value': "ID"},"hashContexts":{'insert-newline': depth0,'focus-out': depth0,'class': depth0,'placeholder': depth0,'value': depth0},"types":[],"contexts":[],"data":data}))));
  data.buffer.push("\r\n");
  return buffer;
},"21":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("                <span class=\"visit-title h4 col-sm-10\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "editLabel", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING"],"contexts":[depth0],"data":data})));
  data.buffer.push(">");
  ...
  var stack1, buffer = '';
  data.buffer.push("                <ul class=\"connectedSortable sortable col-sm-12 ui-droppable ui-sortable\">\r\n");
  stack1 = helpers.each.call(depth0, "visitProc", "in", "visit.procedures", {"name":"each","hash":{
    'itemController': ("procedure")
  },"hashTypes":{'itemController': "STRING"},"hashContexts":{'itemController': depth0},"fn":this.program(24, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                  <p class=\"count_proc pull-right\" id=\"\" style=\"display:block\"> ");
  stack1 = helpers._triageMustache.call(depth0, "visit.proceduresCount", {"name":"_triageMustache","hash":{},"hashTypes":{},"hashContexts":{},"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push(" procedures</p>\r\n                </ul>\r\n");
  return buffer;
},"24":function(depth0,helpers,partials,data) {
  var stack1, buffer = '';
  data.buffer.push("                    <li class=\"ui-state-default\">\r\n");
  stack1 = helpers.unless.call(depth0, "visitProc.isEditingName", {"name":"unless","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(25, data),"inverse":this.program(27, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("                    </li>\r\n");
  return buffer;
},"25":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("                        <span class=\"procedure\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "editName", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING"],"contexts":[depth0],"data":data})));
  data.buffer.push(">");
  ...
  data.buffer.push("        <div class=\"col-sm-3 col-sm-2_4\"></div>\r\n");
  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, escapeExpression=this.escapeExpression, buffer = '';
  ...
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\r\n      <button class=\"btn btn-primary pull-right\" style=\"margin-top: 35px; margin-bottom: 10px;\" ");
  ...
  stack1 = helpers.each.call(depth0, "procedure", "in", "procedures", {"name":"each","hash":{
    'itemController': ("procedure")
  },"hashTypes":{'itemController': "STRING"},"hashContexts":{'itemController': depth0},"fn":this.program(9, data),"inverse":this.program(15, data),"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("          </ul>                \r\n        <p class=\"count_proc\" id=\"number\" style=\"display:block\"> ");
  stack1 = helpers._triageMustache.call(depth0, "proceduresCount", {"name":"_triageMustache","hash":{},"hashTypes":{},"hashContexts":{},"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
